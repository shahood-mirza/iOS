...
#import "Property2ViewController.h"

@interface Property2ViewController ()

@end

@implementation Property2ViewController
...
//pull all of player 2's properties from the database
-(NSMutableArray *) propertiesList{
    ...
    @try
    {
        ...
        const char *sql = "SELECT name FROM properties INNER JOIN ownableproperties ON properties.position=ownableproperties.position AND ownableproperties.owner = 'P2'";
